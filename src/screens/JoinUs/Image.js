		...
		<Col sm={24} md={20} lg={14}>
			<DescriptionCard className="text-center">
				<p className="description">
					Vous avez de l'énergie, un peu de temps disponible et vous
					êtes motivé(e) pour rejoindre la communauté Anticovid ?
				</p>
				<p className="encouragement">
					Nous sommes ravis de vous accueillir ! Quelle est votre
					compétence ?
				</p>
			</DescriptionCard>
		</Col>
